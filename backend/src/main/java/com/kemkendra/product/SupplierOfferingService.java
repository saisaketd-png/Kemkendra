...
public class SupplierOfferingService {
    ...
    private SupplierOfferingResponse toResponse(SupplierOffering offering) {
        ...
        return new SupplierOfferingResponse(
                ...
                offering.getSupplier() != null ? resolveSupplierLogoUrl(offering.getSupplier()) : null,
    ...
    /**
     * Resolves the supplier logo URL for API responses.
     * Prefers the dynamic content endpoint when a stored logo file exists.
     */
