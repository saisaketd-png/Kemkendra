package com.kemkendra.order.apis;
...
public class PurchaseOrderController {
    ...
    public PurchaseOrderResponse rejectSupplierOrder(
            @PathVariable UUID orderId,
            @Valid @RequestBody com.kemkendra.order.dto.RejectPurchaseOrderRequest request,
            Authentication authentication) {
    ...
    public PurchaseOrderResponse shipSupplierOrder(
            @PathVariable UUID orderId,
            @Valid @RequestBody com.kemkendra.order.dto.ShipOrderRequest request,
            Authentication authentication) {
    ...
    @PreAuthorize("hasRole('BUYER') or hasRole('USER') or hasRole('SUPPLIER')")
    public com.kemkendra.order.dto.ShipmentResponse getShipment(
            @PathVariable UUID orderId,
            Authentication authentication) {
    ...
    public PurchaseOrderResponse cancelOrder(
            @PathVariable UUID orderId,
            @Valid @RequestBody com.kemkendra.order.dto.CancelPurchaseOrderRequest request,
            Authentication authentication) {
